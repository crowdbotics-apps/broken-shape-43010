"""
Django settings for broken_shape_43010 project.
...
ROOT_URLCONF = 'broken_shape_43010.urls'
...
WSGI_APPLICATION = 'broken_shape_43010.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "broken_shape_43010 API",
    "DESCRIPTION": "API documentation for broken_shape_43010 App",
    "VERSION": "v1",
}
